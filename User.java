...
public class User {
    ...
    public void getAllUsers() {
        ...
        try {
            ...
            String query = "SELECT users.id, users.username, credentials.first_name, credentials.last_name FROM users JOIN credentials ON users.id = credentials.users_id";
        ...
        try {
            ...
            if (!isExist) {
                ...
                if (res.next()) {
                    ...
                    String newQuery = "INSERT INTO credentials(users_id, first_name, last_name) VALUES(?,?,?)";
    ...
    public void updateUser(String id, String username, String password) {
        ...
        try {
            Connection con = conn.getConnection();
            String query = "UPDATE credentials SET first_name = ?, last_name = ? WHERE users_id = ?"; // Complete this query
            PreparedStatement stmt = con.prepareStatement(query);
            stmt.setString(1, username);
            stmt.setString(2, password);
            stmt.setString(3, id);
    ...
    public void deleteUser(String id) {
        try {
            Connection con = conn.getConnection();
            String credQuery = "DELETE FROM credentials WHERE users_id = ?"; // 6. Complete this query
    ...
    public void updateUserCredential(String id, String first_name, String last_name) {
        try {
            ...
            String credQuery = "UPDATE credentials SET first_name = ?, last_name = ? WHERE users_id=?";
            PreparedStatement credStmt = con.prepareStatement(credQuery);
